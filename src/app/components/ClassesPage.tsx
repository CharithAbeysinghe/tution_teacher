...
const allClasses = [
  { id: 1, subject: "Mathematics", grade: "Grade 10", medium: "Sinhala", fee: 2500, day: "Monday & Thursday", time: "4:00 – 6:00 PM", seats: 20, enrolled: 18, teacher: "Mr. Aravinda", description: "Comprehensive O/Level Mathematics covering algebra, geometry, statistics and advanced problem solving." },
  { id: 2, subject: "Mathematics", grade: "Grade 11", medium: "English", fee: 2500, day: "Monday & Thursday", time: "6:00 – 8:00 PM", seats: 15, enrolled: 12, teacher: "Mr. Aravinda", description: "O/Level Mathematics (English medium) with intensive exam technique practice and past paper revision." },
  { id: 3, subject: "Science", grade: "Grade 8", medium: "Sinhala", fee: 2000, day: "Tuesday & Friday", time: "3:30 – 5:00 PM", seats: 20, enrolled: 14, teacher: "Mr. Aravinda", description: "Junior Science covering Biology, Chemistry, and Physics foundations with practical examples." },
  { id: 4, subject: "Science", grade: "Grade 9", medium: "Sinhala", fee: 2000, day: "Tuesday & Friday", time: "5:00 – 6:30 PM", seats: 20, enrolled: 16, teacher: "Mr. Aravinda", description: "Intermediate Science with deeper coverage of chemical equations, force, and living systems." },
  { id: 5, subject: "English", grade: "Grade 6", medium: "English", fee: 1800, day: "Wednesday & Saturday", time: "9:00 – 10:30 AM", seats: 15, enrolled: 10, teacher: "Mr. Aravinda", description: "Foundation English focusing on grammar, comprehension, and creative writing for young learners." },
  { id: 6, subject: "English", grade: "Grade 7", medium: "English", fee: 1800, day: "Wednesday & Saturday", time: "10:30 AM – 12:00 PM", seats: 15, enrolled: 11, teacher: "Mr. Aravinda", description: "Intermediate English with essay writing, letter writing, and comprehension skills development." },
];
    ...
    <div style={{ fontFamily: "var(--font-body)" }}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtered.map((cls) => {
            const availability = cls.seats - cls.enrolled;
            const pct = (cls.enrolled / cls.seats) * 100;
            return (
              <div key={cls.id} className="rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow" style={{ background: "var(--card)", border: "1px solid var(--border)" }}>
                ...
                <div className="px-5 py-4">
                  <div className="flex flex-col gap-2.5 mb-4">
                    {[
                      { icon: Clock, text: `${cls.day}, ${cls.time}` },
                      { icon: DollarSign, text: `Rs. ${cls.fee.toLocaleString()} / month` },
                      { icon: Users, text: `${cls.enrolled}/${cls.seats} students enrolled` },
